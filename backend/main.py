...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", 'https://dassie-pumped-vertically.ngrok-free.app', 'https://poligon-mkk.vercel.app'],  # Next.js default port, ngrox domain for testing
